...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002007150398')
...
URL = "https://svnh-auto-filter-cb378710a571.herokuapp.com/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://svnh-auto-filter-cb378710a571.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://svnh-auto-filter-cb378710a571.herokuapp.com/".format(FQDN)
else:
    URL = "https://svnh-auto-filter-cb378710a571.herokuapp.com/".format(FQDN)
